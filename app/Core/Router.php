...
class Router
{
    ...
    private const API_ROUTES = [
        ...
        'updateRates' => ['Controllers\Api\AdminController', 'updateRates'],
        'changeCurrency' => ['Controllers\Api\BalanceController', 'changeCurrency'],
        'users' => ['Controllers\Api\AdminController', 'users'],
        'bets' => ['Controllers\Api\BetController', 'bets'],
        'myBets' => ['Controllers\Api\BetController', 'myBets'],
        'placeBet' => ['Controllers\Api\BetController', 'placeBet'],
        'settleBet' => ['Controllers\Api\BetController', 'settleBet'],
        'updateBalance' => ['Controllers\Api\AdminController', 'updateBalance'],
        'setBalance' => ['Controllers\Api\AdminController', 'setBalance'],
        'userBalances' => ['Controllers\Api\AdminController', 'userBalances'],
        'profile' => ['Controllers\Api\ProfileController', 'show'],
        'logs' => ['Controllers\Api\LogController', 'logs'],
        'adminLogs' => ['Controllers\Api\LogController', 'adminLogs'],
        'addContact' => ['Controllers\Api\ContactController', 'add'],
        'deleteContact' => ['Controllers\Api\ContactController', 'delete'],
        'adminAddContact' => ['Controllers\Api\ContactController', 'adminAdd'],
        'adminDeleteContact' => ['Controllers\Api\ContactController', 'adminDelete'],
        'adminUserContacts' => ['Controllers\Api\ContactController', 'adminUserContacts'],
    ];
